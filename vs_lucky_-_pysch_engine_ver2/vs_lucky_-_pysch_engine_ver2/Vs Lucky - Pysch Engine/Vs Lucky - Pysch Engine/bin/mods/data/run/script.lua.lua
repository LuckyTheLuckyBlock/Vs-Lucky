...
doTweenX('luckyboi-bobhell', 'luckyboi-bobhell.scale', 0 - 50*math.sin((currentBeat+1*0.1)*math.pi), 6)
doTweenY('luckyboi-bobhell', 'luckyboi-bobhell.scale', 0 - 31*math.sin((currentBeat+1*1)*math.pi), 6)
