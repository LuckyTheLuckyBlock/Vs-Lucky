...
doTweenX('luckyboi-bob', 'luckyboi-bob.scale', 0 - 50*math.sin((currentBeat+1*0.1)*math.pi), 6)
doTweenY('luckyboi-bob', 'luckyboi-bob.scale', 0 - 31*math.sin((currentBeat+1*1)*math.pi), 6)
