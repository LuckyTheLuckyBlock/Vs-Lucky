...
doTweenX('luckyboi-angrybob', 'luckyboi-angrybob.scale', 0 - 50*math.sin((currentBeat+1*0.1)*math.pi), 6)
doTweenY('luckyboi-angrybob', 'luckyboi-angrybob.scale', 0 - 31*math.sin((currentBeat+1*1)*math.pi), 6)
